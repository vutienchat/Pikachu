...
import {isplay, processGameItemClicked, resetGame } from "../component/handlePlayGame";
...
class PlayPokemonPage {
    async render() {
        ...
        const listPokemons = ListPokemonObj.map(pokemon => {
            return /*html*/ `
                 <div class= "p-1 text-center bg-white chon cursor-pointer transition duration-500 rounded-md border-2 border-black" data-id = ${pokemon.id}>
        ...
        return /*html*/`
         <div class= "w-3/5 mx-auto">
            <h1 class="text-center text-4xl font-momo font-semibold my-2 uppercase text-white">Pokemon</h1> 
            <div class="flex justify-between items-center pb-1">
               ...
               <div> 
                    ...
                    <span class="text-red-500 font-black text-2xl" id='countDown'>60</span>
               </div>
               <div> 
